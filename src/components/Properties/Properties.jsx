...
border-[1.5px] border-[#1F4B43]"
                >
                  ...
                  />
                  <label className="block mx-2 text-sm text-[#1F4B43]">
                    To
                  </label>
                  <input
                    type="number"
...
border-[1.5px] border-[#1F4B43]"
              ...
              <div className="mb-4  text-sm">
                ...
                <div
                  className="w-full flex lg:flex-row sm:flex-wrap items-center justify-start
          ...
          <>
            <div className="mb-4 mx-10 mt-4 text-sm grid grid-cols-3 gap-1 items-center justify-start">
              ...
              <div className="mb-4 text-sm">
                ...
                <select
                  className="w-52 p-2 border-[1.5px] rounded-lg tex-sm placeholder:text-[#1F4B43]
                 border-[#1F4B43]"
                >
