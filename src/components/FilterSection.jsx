...
const FilterSection = () => {
  ...
  <div
    className="absolute text-[.6rem] left-1/2 transform -translate-x-1/2 top-full w-full text-center md:text-start h-auto md:w-[80%] md:h-[10vh] 
    bg-black text-white grid grid-cols-1 md:flex items-center justify-between px-2 py-4 md:py-2 md:px-4 rounded-none md:rounded-lg shadow-lg z-[9]"
  >
    {/* Input Field */}
    <input
      type="text"
    ...
    <button className="flex items-center border border-gray-700 text-white 
      ...
      <span className="w-4 h-4 mr-2">
        {/* Assuming FilterLogo is a component */}
        <FilterLogo />
      </span>
      Filter
    </button>
