...
const FilterTwo = () => {
  return (<>
    <div className="relative w-full mb-[350px] sm:mb-[150px] md:mb-[150px] lg:mb-[100px] flex justify-center mt-0 ">
      <div className="absolute text-[.7rem] md:text-[.6rem] left-1/2 transform -translate-x-1/2 
        ...
        {/* Filter Button */}
        <button className="flex mt-3 md:mt-0 items-center border border-gray-700 text-white 
        ...
        {/* Search Button */}
        <button className="bg-[#E7C873] mt-4 md:mt-0  text-black px-6 py-2 rounded-lg 
