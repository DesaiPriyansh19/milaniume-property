  ...
  return (
    <>
      <div className="flex justify-center  md:justify-between items-center mt-16 px-4 md:px-4 md:mr-7 ">
        ...
        <Link to={"/ourservices"}>
          <button
            className=" hidden md:flex text-sm border text-center px-4  py-1 
  border-[#1F4B43] hover:bg-[#e6f6f3] rounded-md"
          >
            Explore &#8594;
          </button>
        </Link>
      ...
      <p className="text-sm text-center md:text-start px-20 text-gray-500 ">
        {" "}
      ...
      <div className="grid grid-cols-3 mt-5 px-5 md:px-10 lg:px-0 lg:flex gap-4 lg:gap-2 xl:gap-24 mx-auto items-center  justify-center py-3">
        ...
        <Link
          onClick={() => {
            setActiveTab("Agricultural Plot");
          }}
          to={"/properties"}
        >
          <div
         ...
         md:w-[120px] lg:w-[150px] xl:h-[170px] xl:w-[160px]  flex-col justify-center items-center"
          >
            ...
            <p className="text-[.8rem] font-semibold">
              Agriculture Land & <br></br> Project Land
            </p>
          </div>
        </Link>
      ...
      <Link to={"/ourservices"}>
        <button className=" md:hidden ml-7 flex text-sm border text-center px-4 py-1 border-[#1F4B43] rounded-md">
          Explore &#8594;
        </button>
      </Link>
    </>
