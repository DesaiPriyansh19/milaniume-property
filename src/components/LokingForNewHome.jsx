...
function LokingForNewHome() {
  ...
  return (
    <>
<div className="w-[97%] md:w-[90%] lg:w-[90%] mx-auto xl:w-full xl:max-w-none flex flex-col md:flex-row justify-center gap-6 p-6 md:p-12">
  {/* First Div */}
  <div className="flex-1 bg-[#F9F9F9] 
    ...
    <p className="text-[.7rem] mb-8 pr-11">
      Many offers every day. Don't miss offers <br></br>on-site, trusted by a community of thousands of users.
    </p>
      <Link to={'/properties'}><button className="bg-[#1F4B43] text-sm text-white px-6 py-2 rounded-lg ">
      Get Started &#8594;
    </button></Link>
    {/* Small "A" at Bottom Right */}
    <span className="absolute bottom-4 right-4 w-[60px] md:w-[90px] xl:w-[190px] "><img src={homimg2}/></span>
  </div>
  ...
  <div className="flex-1 bg-[#FFF8F6] 
    ...
    {/* Small "A" at Bottom Right */}
    <span className="absolute bottom-4 right-4 w-[60px] md:w-[90px] xl:w-[190px]"><img src={homimg}/></span>
  </div>
</div>
