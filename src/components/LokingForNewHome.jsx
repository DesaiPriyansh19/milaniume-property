...
function LokingForNewHome() {
  ...
  return (
   ...
   lg:w-[100%] mx-auto xl:w-full xl:max-w-none flex flex-col md:flex-row justify-center 
   gap-2 lg:gap-6 p-6 md:p-12">
  {/* First Div */}
  ...
  <span className="absolute bottom-4 right-4 md:right-0 lg:right-4 w-[60px] md:w-[90px]  xl:w-[150px]">
  ...
  <button className="bg-[#1F4B43] absolute bottom-7 mt-3 text-sm text-white px-5 sm:px-2 lg:px-6 py-2 rounded-lg transition-transform transform hover:scale-105 hover:shadow-lg">
    Post Property &#8594;
  </button>
</Link>
