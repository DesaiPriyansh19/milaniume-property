...
function SignInDiv() {
  return (
<div className='w-full sm:w-[90%] md:w-[75%] rounded-xl px-4 sm:pl-10 sm:pr-0 gap-4 py-4 sm:py-10 mt-12 sm:mt-24 mb-6 sm:mb-9 flex flex-wrap sm:flex-nowrap justify-center items-center mx-auto bg-[#1F4B43]'>
